            ...
            _calculateChange = (ThrowPropsPlugin.calculateChange = function(
                ...
                var e =
                    ease instanceof Ease
                        ...
                        : new Ease(ease);
                return (
                    (duration * checkpoint * velocity) / e.getRatio(checkpoint)
                );
            }),
            _calculateDuration = (ThrowPropsPlugin.calculateDuration = function(
                ...
                var e =
                    ease instanceof Ease
                        ...
                        : new Ease(ease);
                return Math.abs(
                    ((end - start) * e.getRatio(checkpoint)) /
                        velocity /
                        checkpoint
                );
            }),
                    ...
                    for (p in e) {
                        if (
                            ...
                            if (typeof val === "object") {
                                ...
                                tracker =
                                    tracker || VelocityTracker.getByTarget(t);
                                if (tracker && tracker.isTrackingProp(p)) {
    ...
    function() {
        ...
        p.addProp = function(prop, type) {
            if (!this._lookup[prop]) {
                ...
                vp.type =
                    type || (vp.css && prop.indexOf("rotation") === 0)
                        ? "deg"
                        : "";
                vp.v1 = vp.v2 = vp.css
                    ? _getStyle(t, vp.p)
